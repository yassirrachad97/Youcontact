          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <form action="" method="POST">
                ...
                <p id="error" style="display:none; color: red;">emaile ou password inccorect!!</p>
...
if (isset($_POST['ok'])) {
  ...
  $sql = "SELECT * FROM utilisateur WHERE email='$usernam' AND password='$password'";
  $reponse = mysqli_query($conn, $sql);
  if ($reponse->num_rows > 0) {
    $userData = mysqli_fetch_assoc($reponse);
